...
$(function() {
	...
	//验证确认密码是否和密码相同
	jQuery.validator.addMethod("isEqual",function(value,element,params){
		return value == $(params).val();
	},"两次输入密码不相同");

	jQuery.validator.addMethod("userNameAvaliable",function(value,element,params){
		
		var isAvaliable = null;
		$.ajax({
			url : params[0],
			xhrFields: {
